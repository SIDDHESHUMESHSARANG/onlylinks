...
export default function LinkEnter({ type, selectedValue, setSelectedValue, setShowFlex, setLink, loading }) {
    ...
    const handleVerfication = () => {
        ...
        const regexMap = {
            ...
            other: /^(https?:\/\/)?[\w.-]+(\.[a-z]{2,})+\S*$/i
        };
        const appKey = selectedValue.toLowerCase();
        let regex = regexMap[appKey];
        if (!regex) {
            // fallback for 'other' or unknown
            regex = regexMap.other;
        }
    ...
    return (
        ...
        <div className="flex flex-1 justify-center items-center min-h-[0vh] z-10 mt-50 mr-[170px] link-enter-panel">
           <div className="flex flex-col items-center gap-2">
                ...
                <Button 
                    className="proceed px-[60px] py-[30px] w-[100px] mt-[102px] border-[#181818] cursor-pointer transform scale-100 active:scale-110 transition-transform duration-200"
                    type="submit"
